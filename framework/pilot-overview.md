...
PACTO is grounded in real pilot implementations, not abstract theory. Each pilot tests different aspects of the framework in distinct cultural, ecological, and institutional contexts.
...
Biocultural credit development with First Nations communities in the Columbia River Basin, focused on salmon ecosystem health indicators. Tests PACTO's applicability outside tropical forest ecosystems, with different governance traditions, ecological focus, and legal context.

## ASHA — Strategic Pilot

The Amazon Sacred Headwaters Alliance is a multilateral bioregional fund. PACTO has been proposed as a component of its governance framework, serving as the integrity layer for community assembly processes. This is PACTO's highest-scale application — operating across multiple indigenous nations, countries, and ecological contexts.

---

## Cross-Pilot Patterns

1. **Community assembly is the foundation** — every pilot begins with existing community governance structures
2. **Voice is primary source** — transcription and synthesis of community voice drives indicator and agreement development
3. **Local partners are essential** — PACTO requires trusted intermediaries who understand both the community and the technical stack
4. **Biocultural indicators are community-specific** — no universal indicator set; each community defines what matters in their territorial context

---

*Detailed pilot documentation, including indicator definitions, lessons learned, and process records, is available to partners via the KOI Knowledge Commons.*
