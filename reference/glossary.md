...
|-----------|-------------|------------|
| **PACTO** | **PACTO** | Participatory Assembly & Co-creation Through Technology. Also *pacto* = agreement/pact in plain Spanish. |
...
| **Implementation Gap** | **Brecha de Implementación** | The gap between consent as an established participatory right and how it is implemented in practice — often reduced to procedural minimum compliance rather than substantive participation. |
| **Surveillance Inversion** | **Inversión de Vigilancia** | PACTO's design principle: technology serves communities (reflecting their priorities in agreements) rather than watching them (monitoring compliance). |
...
| **Layer 4 (Constitutional)** | **Capa 4 (Constitucional)** | Decisions governed by community governance traditions. Always human, always community-led. 0% automation. |
| **Legal Pluralism** | **Pluralismo Jurídico** | Agreements simultaneously valid under multiple legal frameworks — customary law, national law, and on-chain governance. |
...
## Context: Indigenous Rights — Governance
...
## Context: Indigenous Rights — Credit & Methodology
...
## Context: Indigenous Rights — Pilots
...
*Contributions to this glossary are welcome. See [CONTRIBUTING.md](../CONTRIBUTING.md) for guidelines. For indigenous language terms, the [Community Rights and Process Integrity checklist](../contexts/indigenous-rights/process-integrity.md) must be completed before publication.*
